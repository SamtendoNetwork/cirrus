...
4. Run the Cirrus homebrew and select either to use a Pretendo or Nintendo account
...
1. Clone the repository recursively using `git clone https://github.com/PretendoNetwork/Cirrus --recursive`
...
3. Copy [decompressed `code.bin`](https://github.com/PretendoNetwork/Cirrus/blob/main/DECOMPRESSING.md) files from the act, friends, http, miiverse, socket and ssl sysmodules in their respective `patches` directories (any Miiverse code.bin works for the miiverse module)
4. Run `make`
...
- [TraceEntertains](https://github.com/TraceEntertains) for making a CIA version of Cirrus and maintaining the project
